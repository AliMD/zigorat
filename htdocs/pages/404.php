<?php 
	...
	switch ($err){
		...
		case 402:
		case 403:
			$title="Error $err (Forbidden) !!!";
			$msg="Your client does not have permission to get URL <code>$url</code>";
			break;
		case 404:
			$title="Error $err (Not Found) !!!";
			$msg="The requested URL <code>$url</code> was not found on this server.";
			break;
		// TODO: other err msg (http://en.wikipedia.org/wiki/List_of_HTTP_status_codes)
		case 500:
		case 501:
		case 502:
		case 503:
		...
		case 509:
		case 510:
			$title="Error $err (Server Err) !!!";
			$msg="Sorry, We have Internal Server Error. Try again later.";
			break;
		default:
			$title="Error $err !!!";
			$msg="Can not access URL <code>$url</code>";
	}
?>
<!DOCTYPE html>
<html lang="en-US">
...
<body>
<a href="/" id="g"><img src="//www.google.com/images/logo_sm.gif" alt="Google" /></a>
<p><b><?php echo $err; ?>.</b> <ins>That’s an error.</ins></p>
<p><?php echo $msg; ?> <ins>That’s all we know.</ins></p>
</body>
</html>